export const APP_CONFIG = {
    ...
    clerkPublishableKey: 'pk_test_cXVhbGl0eS1oYXJlLTk5LmNsZXJrLmFjY291bnRzLmRldiQ',
    clerkScriptUrl: 'https://cdn.jsdelivr.net/npm/@clerk/clerk-js@latest/dist/clerk.browser.js'
};
